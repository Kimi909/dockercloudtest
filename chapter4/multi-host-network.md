...
vagrant@docker-node1:~$ nohup ./etcd --name docker-node1 --initial-advertise-peer-urls http://192.168.11.4:2380 \
--listen-peer-urls http://192.168.11.4:2380 \
--listen-client-urls http://192.168.11.4:2379,http://127.0.0.1:2379 \
--advertise-client-urls http://192.168.11.4:2379 \
--initial-cluster-token etcd-cluster \
--initial-cluster docker-node1=http://192.168.11.4:2380,docker-node2=http://192.168.11.9:2380 \
...
vagrant@docker-node2:~$ nohup ./etcd --name docker-node2 --initial-advertise-peer-urls http://192.168.11.9:2380 \
--listen-peer-urls http://192.168.11.9:2380 \
--listen-client-urls http://192.168.11.9:2379,http://127.0.0.1:2379 \
--advertise-client-urls http://192.168.11.9:2379 \
--initial-cluster-token etcd-cluster \
--initial-cluster docker-node1=http://192.168.11.4:2380,docker-node2=http://192.168.11.9:2380 \
--initial-cluster-state new&
```
...
$ sudo /usr/bin/dockerd -H tcp://0.0.0.0:2375 -H unix:///var/run/docker.sock --cluster-store=etcd://192.168.11.4:2379 --cluster-advertise=192.168.11.4:2375&
```
...
```
$ sudo service docker stop
$ sudo /usr/bin/dockerd -H tcp://0.0.0.0:2375 -H unix:///var/run/docker.sock --cluster-store=etcd://192.168.11.9:2379 --cluster-advertise=192.168.11.9:2375&
```
